...
public class MainActivity extends ActionBarActivity implements ActionBar.TabListener {
    ...
    public class SectionsPagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            ...
            // Return a RecordFragment (defined as a static inner class below).
            if (position == 0)
                return RecordFragment.newInstance(position + 1);
            if (position == 1)
                return ListenFragment.newInstance(position + 1);
            else
                return OrganizeFragment.newInstance(position + 1);
        }
    ...
    public static class ListenFragment extends Fragment {
         ...
         * number.
         */
        public static ListenFragment newInstance(int sectionNumber) {
    ...
    public static class OrganizeFragment extends Fragment {
        /**
         * The fragment argument representing the section number for this
         * fragment.
         */
         ...
         * number.
         */
        public static OrganizeFragment newInstance(int sectionNumber) {
